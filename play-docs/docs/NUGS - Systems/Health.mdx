...
<BlueprintFlowPlaceholder title="AC_Health, Take Damage Function Placeholder" />

### AC_Health, Heal Function

<BlueprintFlowPlaceholder title="AC_Health, Heal Function Placeholder" />

### AC_Health, Lives Lost Function

<BlueprintFlowPlaceholder title="AC_Health, Lives Lost Function Placeholder" />

### Hazard Damage Test

<BlueprintFlowPlaceholder title="Hazard Damage Test Placeholder" />

### Physical Material Damage Logic

<BlueprintFlowPlaceholder title="Physical Material Damage Logic Placeholder" />
